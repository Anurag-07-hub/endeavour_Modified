...
export function GalleryPage() {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-[100svh] bg-[#0A0A0A] overflow-hidden pt-[80px]">
            <style>{`
                @keyframes load {  
                    0% { opacity: 0;}    
                    100% { opacity: 1;}    
            ...
            >
                <div
                    style={{
                        ...
                        height: "4em",
                        borderRadius: "50%",
                        background: "rgba(152, 192, 239, 0.8)",
                        boxShadow: "0 0 5em 2em #98c0ef",
                        filter: "blur(10px)",
                    }}
                />
                ...
                <div
                    style={{
                        ...
                        backgroundImage: "linear-gradient(90deg, transparent 10%, rgba(124, 145, 182, 0.1) 30%, rgba(124, 145, 182, 0.4) 50%, rgba(124, 145, 182, 0.1) 70%, transparent 90%)",
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000 z-10">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.h1
                        ...
                        className="text-2xl font-medium tracking-tight text-white md:text-4xl drop-shadow-md"
                    >
                ...
                {/* Main Container */}
                <div className="relative flex items-center justify-center w-full h-full mt-4">
