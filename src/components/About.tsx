...
export function About() {
  return (
    <section id="about" className="py-[100px] bg-black/30 border-t border-white/10 relative z-10">
      <div className="max-w-[1024px] mx-auto px-[60px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          
          <div>
            <FadeIn direction="right" delay={0.1}>
              <h2 className="font-sans text-[48px] md:text-[64px] font-black uppercase tracking-[-2px] text-white mb-6 leading-[0.9]">
                Empowering the innovators of <span className="text-brand-accent">tomorrow</span>.
              </h2>
            </FadeIn>
            <FadeIn direction="right" delay={0.2}>
              <p className="text-brand-muted text-[16px] leading-[1.6] mb-8 font-sans">
              ...
              <p className="text-brand-muted text-[16px] leading-[1.6] font-sans">
            ...
            <FadeIn direction="up" delay={0.3} className="mt-12 grid grid-cols-2 gap-8 border-t border-white/10 bg-brand-accent/20 backdrop-blur-md p-[30px]">
              <div className="flex flex-col gap-2">
                <h3 className="font-mono text-[32px] font-bold text-brand-accent">15+</h3>
                <p className="font-sans text-brand-muted text-[10px] uppercase tracking-[2px] font-bold">Years of Legacy</p>
              </div>
              <div className="flex flex-col gap-2">
                <h3 className="font-mono text-[32px] font-bold text-brand-accent">50+</h3>
                <p className="font-sans text-brand-muted text-[10px] uppercase tracking-[2px] font-bold">Active Members</p>
              </div>
              <div className="flex flex-col gap-2">
                <h3 className="font-mono text-[32px] font-bold text-brand-accent">12</h3>
                <p className="font-sans text-brand-muted text-[10px] uppercase tracking-[2px] font-bold">National Trophies</p>
              </div>
              <div className="flex flex-col gap-2">
                <h3 className="font-mono text-[32px] font-bold text-brand-accent">120+</h3>
