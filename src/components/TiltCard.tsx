...
export function TiltCard({
  ...
  // Using white glare instead of var(--foreground) to match the "motion white blur effect"
  const glareBg = useMotionTemplate`radial-gradient(circle at ${gx}% ${gy}%, rgba(255, 255, 255, 0.45), transparent 50%)`;
